...
const ViewStudentTeacher = () => {
  ...
  return (
    <div className="container">
      ...
      <h2 className="text-2xl font-bold mb-4 mt-10">Students, Classes, and Teachers</h2>
          ...
          <tbody>
            {students.map((student, index) => (
              <tr key={student.id}>
                ...
                <td className="border px-4 py-2">{getClassName(student.id_class)}</td>
                <td className="border px-4 py-2">{getTeacherName(student.id_class)}</td>
              </tr>
            ))}
          </tbody>
        </table>
          ...
          {pageNumbers.map((number) => (
            <button
              ...
              className={`px-3 py-1 rounded ${
                currentPage === number ? 'bg-blue-600 text-white' : 'bg-gray-300 hover:bg-gray-400'
              }`}
            >
              {number}
            </button>
